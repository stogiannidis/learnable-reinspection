#!/bin/bash
# Evaluation on spatial reasoning benchmarks (Qwen3-VL)
#
...
#
# Run with: bash reinspection_qwen3vl/scripts/run_eval.sh
...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-outputs/qwen3vl/stage2/epoch_10}"
OUTPUT_FILE="${OUTPUT_FILE:-outputs/qwen3vl/eval_results.json}"
...
CONFIG="${CONFIG:-reinspection_vlm/configs/qwen3vl/stage2.yaml}"
